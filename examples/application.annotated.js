...
root.addOption(
	new ask.IsolatedOption('help').setShort('h').setDescription('Usage information, just try it')
).addPreController(req => (req.options.help ? helpCommand.call(this, req) : true));
...
root.addCommand('flight', dumpRequestController)
	.addAlias('fly')
	.setDescription('Aww yeah flight controller commands!')
	.addParameter(
		new ask.Parameter('flightId')
			.isRequired(true)
